...
(defcustom session-file-name-history-exclude-regexps
...
(defun session-set-file-name-history ()
  ;; TODO later: test `this-command' matching regexp "find-file" or similar
...
;;       (file-exists-p buffer-file-name) (file-readable-p buffer-file-name)
         (let ((name (session-abbrev-file-name buffer-file-name)) (exclude nil))
           (unless (session-element-exclude-p name session-file-name-history-exclude-regexps)
             (push name file-name-history))))
    (when (session-element-exclude-p last-file-name session-file-name-history-exclude-regexps)
...
(defun session-cleanup-file-name-history-exclude-regexp ()
  "Delete file name matches `session-file-name-history-exclude-regexps' from `file-name-history'."
  (interactive)
  (dolist (afilename file-name-history)
    (catch 'findmatch
      (dolist (aregexp session-file-name-history-exclude-regexps)
        (when (string-match-p aregexp afilename)
          (setq file-name-history (delete afilename file-name-history))
          (throw 'findmatch t))))
    file-name-history))

(defun session-cleanup-file-name-history-not-exist ()
