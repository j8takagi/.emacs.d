...
;; Modified: j8takagi <j8takagi@nifty.com>
;; Version: 1.1
;; Keywords: uniq, duplicates
;;
;; [Commentary]
;;
;; Remove duplicate lines from a region.  uniq-lines behaves in a
;; fashion similar to the Unix utility 'uniq', only removing a line
;; duplicating the immediate antecedent.  uniq-nosort-lines will
...
(defun uniq-nosort-lines (beg end)
