...
(font-lock-add-keywords
 ...
 '(("%.*" . 'font-lock-comment-face)
   ...
   ("\\<abscissa\\>" . 'font-lock-keyword-face)
   ("\\<acos\\>" . 'font-lock-keyword-face)
   ("\\<altitude\\>" . 'font-lock-keyword-face)
   ("\\<and\\>" . 'font-lock-keyword-face)
   ("\\<angle\\>" . 'font-lock-keyword-face)
   ("\\<append\\>" . 'font-lock-keyword-face)
   ("\\<area\\>" . 'font-lock-keyword-face)
   ("\\<arg\\>" . 'font-lock-keyword-face)
   ("\\<arrow\\>" . 'font-lock-keyword-face)
   ("\\<arrows\\>" . 'font-lock-keyword-face)
   ("\\<asin\\>" . 'font-lock-keyword-face)
   ("\\<atan""back\\>" . 'font-lock-keyword-face)
   ("\\<barycenter\\>" . 'font-lock-keyword-face)
   ("\\<bisector\\>" . 'font-lock-keyword-face)
   ("\\<black\\>" . 'font-lock-keyword-face)
   ("\\<blue\\>" . 'font-lock-keyword-face)
   ("\\<box\\>" . 'font-lock-keyword-face)
   ("\\<card\\>" . 'font-lock-keyword-face)
   ("\\<cat\\>" . 'font-lock-keyword-face)
   ("\\<ceil\\>" . 'font-lock-keyword-face)
   ("\\<center\\>" . 'font-lock-keyword-face)
   ("\\<centroid\\>" . 'font-lock-keyword-face)
   ("\\<circle\\>" . 'font-lock-keyword-face)
   ("\\<clamp\\>" . 'font-lock-keyword-face)
   ("\\<clear\\>" . 'font-lock-keyword-face)
   ("\\<close\\>" . 'font-lock-keyword-face)
   ("\\<collinear\\>" . 'font-lock-keyword-face)
   ("\\<conic\\>" . 'font-lock-keyword-face)
   ("\\<cos\\>" . 'font-lock-keyword-face)
   ("\\<cross\\>" . 'font-lock-keyword-face)
   ("\\<cyan\\>" . 'font-lock-keyword-face)
   ("\\<darkgray\\>" . 'font-lock-keyword-face)
   ("\\<dashed\\>" . 'font-lock-keyword-face)
   ("\\<deg\\>" . 'font-lock-keyword-face)
   ("\\<disc\\>" . 'font-lock-keyword-face)
   ("\\<display\\>" . 'font-lock-keyword-face)
   ("\\<distance\\>" . 'font-lock-keyword-face)
   ("\\<dot\\>" . 'font-lock-keyword-face)
   ("\\<dotted\\>" . 'font-lock-keyword-face)
   ("\\<double\\>" . 'font-lock-keyword-face)
   ("\\<draw\\>" . 'font-lock-keyword-face)
   ("\\<eccentricity\\>" . 'font-lock-keyword-face)
   ("\\<element\\>" . 'font-lock-keyword-face)
   ("\\<ellipse\\>" . 'font-lock-keyword-face)
   ("\\<else\\>" . 'font-lock-keyword-face)
   ("\\<elseif\\>" . 'font-lock-keyword-face)
   ("\\<empty\\>" . 'font-lock-keyword-face)
   ("\\<entire\\>" . 'font-lock-keyword-face)
   ("\\<eps\\>" . 'font-lock-keyword-face)
   ("\\<equilateral\\>" . 'font-lock-keyword-face)
   ("\\<error\\>" . 'font-lock-keyword-face)
   ("\\<exp\\>" . 'font-lock-keyword-face)
   ("\\<false\\>" . 'font-lock-keyword-face)
   ("\\<floor\\>" . 'font-lock-keyword-face)
   ("\\<foci\\>" . 'font-lock-keyword-face)
   ("\\<font\\>" . 'font-lock-keyword-face)
   ("\\<for\\>" . 'font-lock-keyword-face)
   ("\\<forth\\>" . 'font-lock-keyword-face)
   ("\\<frame\\>" . 'font-lock-keyword-face)
   ("\\<full\\>" . 'font-lock-keyword-face)
   ("\\<gray\\>" . 'font-lock-keyword-face)
   ("\\<green\\>" . 'font-lock-keyword-face)
   ("\\<half\\>" . 'font-lock-keyword-face)
   ("\\<height\\>" . 'font-lock-keyword-face)
   ("\\<hexagon\\>" . 'font-lock-keyword-face)
   ("\\<homothecy\\>" . 'font-lock-keyword-face)
   ("\\<horizontal\\>" . 'font-lock-keyword-face)
   ("\\<hyperbola\\>" . 'font-lock-keyword-face)
   ("\\<if\\>" . 'font-lock-keyword-face)
   ("\\<in\\>" . 'font-lock-keyword-face)
   ("\\<incircle\\>" . 'font-lock-keyword-face)
   ("\\<intersection\\>" . 'font-lock-keyword-face)
   ("\\<isobarycenter\\>" . 'font-lock-keyword-face)
   ("\\<isosceles\\>" . 'font-lock-keyword-face)
   ("\\<label\\>" . 'font-lock-keyword-face)
   ("\\<length\\>" . 'font-lock-keyword-face)
   ("\\<lightgray\\>" . 'font-lock-keyword-face)
   ("\\<line\\>" . 'font-lock-keyword-face)
   ("\\<ln\\>" . 'font-lock-keyword-face)
   ("\\<local\\>" . 'font-lock-keyword-face)
   ("\\<locus\\>" . 'font-lock-keyword-face)
   ("\\<magenta\\>" . 'font-lock-keyword-face)
   ("\\<major\\>" . 'font-lock-keyword-face)
   ("\\<max\\>" . 'font-lock-keyword-face)
   ("\\<median\\>" . 'font-lock-keyword-face)
   ("\\<midpoint\\>" . 'font-lock-keyword-face)
   ("\\<min\\>" . 'font-lock-keyword-face)
   ("\\<minor\\>" . 'font-lock-keyword-face)
   ("\\<mobile\\>" . 'font-lock-keyword-face)
   ...
   ("\\<ordinate\\>" . 'font-lock-keyword-face)
   ("\\<orthocenter\\>" . 'font-lock-keyword-face)
   ("\\<output\\>" . 'font-lock-keyword-face)
   ("\\<parabola\\>" . 'font-lock-keyword-face)
   ("\\<parallel\\>" . 'font-lock-keyword-face)
   ("\\<parallelogram\\>" . 'font-lock-keyword-face)
   ("\\<pentagon\\>" . 'font-lock-keyword-face)
   ("\\<perimeter\\>" . 'font-lock-keyword-face)
   ("\\<perpendicular\\>" . 'font-lock-keyword-face)
   ("\\<pi\\>" . 'font-lock-keyword-face)
   ("\\<plus\\>" . 'font-lock-keyword-face)
   ("\\<point\\>" . 'font-lock-keyword-face)
   ("\\<polygon\\>" . 'font-lock-keyword-face)
   ("\\<print\\>" . 'font-lock-keyword-face)
   ("\\<projection\\>" . 'font-lock-keyword-face)
   ("\\<pstricks\\>" . 'font-lock-keyword-face)
   ("\\<put\\>" . 'font-lock-keyword-face)
   ("\\<rad\\>" . 'font-lock-keyword-face)
   ("\\<radius\\>" . 'font-lock-keyword-face)
   ("\\<read\\>" . 'font-lock-keyword-face)
   ("\\<rectangle\\>" . 'font-lock-keyword-face)
   ("\\<red\\>" . 'font-lock-keyword-face)
   ("\\<reflection\\>" . 'font-lock-keyword-face)
   ("\\<release\\>" . 'font-lock-keyword-face)
   ("\\<return\\>" . 'font-lock-keyword-face)
   ("\\<right\\>" . 'font-lock-keyword-face)
   ("\\<rotation\\>" . 'font-lock-keyword-face)
   ("\\<round\\>" . 'font-lock-keyword-face)
   ("\\<scale\\>" . 'font-lock-keyword-face)
   ("\\<set\\>" . 'font-lock-keyword-face)
   ("\\<sign\\>" . 'font-lock-keyword-face)
   ("\\<simple\\>" . 'font-lock-keyword-face)
   ("\\<sin\\>" . 'font-lock-keyword-face)
   ("\\<sqrt\\>" . 'font-lock-keyword-face)
   ("\\<square\\>" . 'font-lock-keyword-face)
   ("\\<step\\>" . 'font-lock-keyword-face)
   ("\\<stop\\>" . 'font-lock-keyword-face)
   ("\\<string\\>" . 'font-lock-keyword-face)
   ("\\<sub\\>" . 'font-lock-keyword-face)
   ("\\<symmetric\\>" . 'font-lock-keyword-face)
   ("\\<tan\\>" . 'font-lock-keyword-face)
   ("\\<translation\\>" . 'font-lock-keyword-face)
   ("\\<triangle\\>" . 'font-lock-keyword-face)
   ("\\<triple\\>" . 'font-lock-keyword-face)
   ("\\<true\\>" . 'font-lock-keyword-face)
   ("\\<vector\\>" . 'font-lock-keyword-face)
   ("\\<vertical\\>" . 'font-lock-keyword-face)
   ("\\<while\\>" . 'font-lock-keyword-face)
   ("\\<white\\>" . 'font-lock-keyword-face)
   ("\\<write\\>" . 'font-lock-keyword-face)
   ("\\<yellow\\>" . 'font-lock-keyword-face)))
...
(define-derived-mode eukleides-mode fundamental-mode "Eukleides"
  ...
  (put 'eukleides-mode 'font-lock-keywords
