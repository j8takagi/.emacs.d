...
(defcustom eukleides-image-type (cdar image-format-suffixes)
...
(font-lock-add-keywords
 ...
 (mapcar
  ...
  '("abs" "abscissa" "acos" "altitude" "and" "angle" "append" "area"
    ...
    "black" "blue" "box" "card" "cat" "ceil" "center" "centroid"
    "circle" "clamp" "clear" "close" "collinear" "conic" "cos" "cross"
    "cyan" "darkgray" "dashed" "deg" "disc" "display" "distance" "dot"
    "dotted" "double" "draw" "eccentricity" "element" "ellipse" "else" "elseif"
    "empty" "entire" "eps" "equilateral" "error" "exp" "false" "floor"
    "foci" "font" "for" "forth" "frame" "full" "gray" "green"
    "half" "height" "hexagon" "homothecy" "horizontal" "hyperbola" "if" "in"
    "incircle" "intersection" "isobarycenter" "isosceles" "label" "length" "lightgray" "line"
    "ln" "local" "locus" "magenta" "major" "max" "median" "midpoint"
    "min" "minor" "mobile" "mod" "none" "not" "number" "on"
    "or" "ordinate" "orthocenter" "output" "parabola" "parallel" "parallelogram"
    "pentagon" "perimeter" "perpendicular" "pi" "plus" "point" "polygon" "print"
    "projection" "pstricks" "put" "rad" "radius" "read" "rectangle" "red"
    "reflection" "release" "return" "right" "rotation" "round" "scale" "set"
    "sign" "simple" "sin" "sqrt" "square" "step" "stop" "string"
    "sub" "symmetric" "tan" "translation" "triangle" "triple" "true" "vector"
    "vertical" "while" "white" "write" "yellow" )))
...
curve\\|invalid length\\)" nil t)
    ...
    (let ((outwin (display-buffer (current-buffer))))
      ...
      (setq default-directory (file-name-directory srcfile)
            compilation-directory (list default-directory))
...
(fset 'eukleides-interactive-value
      (lambda (val)
