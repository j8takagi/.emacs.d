ElScreen-GF 1.5.2 README file

This is the distribution of ElScreen-GF 1.5.2, released November 2006.
It is an Emacs interface to GNU grep (or its compatibles), GNU ID
Utils, cscope, and GNU GLOBAL.  ElScreen-GF make it easier to search
...
ElScreen-GF supports the followings as external program:
  ...
  - GNU GLOBAL (http://www.gnu.org/software/global/)
    ...
    locate a symbol in the source files.  GNU GLOBAL earlier than
    versino 5.0 does not support gnu-style output, therefore
    ElScreen-GF needs `sed' to work with such a old GNU GLOBAL.  In
    addition, ElScreen-GF uses `sort' to sort its output.
...
This package should contain the following files:
    ...
    elscreen-gf.el  ElScreen-GF 1.5.2 main file.
    README          Introduction to ElScreen-GF 1.5.2 (this file)
